...
class ViewAllEvents extends BindingClass {
    constructor() {+
        super();
        this.bindClassMethods(['clientLoaded', 'mount','redirectProfile','thisPageRemoveFrom','redirectAllEvents',
        'redirectCreateEvents','redirectAllFollowing','logout','addEvents','addName','addFollowing'], this);
